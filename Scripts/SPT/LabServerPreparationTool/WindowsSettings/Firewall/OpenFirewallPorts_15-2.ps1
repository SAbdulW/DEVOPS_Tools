...
foreach {
	...
	$mySiteCorrectIPs = $mySiteIps.MySiteIps
		...
		if ($scope -eq "All") { 
		netsh advfirewall firewall add rule name="WFO $rulename" dir=in action=allow profile=any localport="$localport" protocol="$protocol" 
		} 
		...
		netsh advfirewall firewall add rule name="WFO $rulename" dir=in action=allow profile=any remoteip="$mySiteCorrectIPs" localport="$localport" protocol="$protocol" 
		} 
 ...
 # Open WMI rules for remote SR installation
 # According to MS KBA https://msdn.microsoft.com/en-us/library/jj980508(v=winembedded.81).aspx 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDrpuLRWTncSyE+
# a+/JHNTgLEYWfbY2DI1a1jjk45AUGqCCGS8wggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# gjcCARUwLwYJKoZIhvcNAQkEMSIEIAGhKdofMOosAwNIfTqZb7rBEp5HkqXPdoFp
# gidip+wwMA0GCSqGSIb3DQEBAQUABIIBAFim3hvAusAJyGEk9/E77fsjTnxavHrb
# P4Tf41Oky2I6PHdQVASYCBsKXxLMYwMtGced0v4ZH4udRawIBU2xHs6s82Q9JaXo
# wnVlCL2A5A73deQCfgVquh4Bpj/miCtiQhyDJLkasK3L2YMn2WCYqVtfDq39JMQ1
# JwNBlUnbBg4EgwuqNw7dFgEhCKAl+5xeQvCDzkFIRxTysjdWesqPapdGaiimFTo7
# KEssZ8T24HfJkdvf7ipgBZ/cZCdnRXVvBWj58e4+EBGE3tYZnC5xtWOGK7vw0xGg
# iYLZ8pCrwHqL1TVsknt4vUTSOcbL+nzobJujMeILuLZYj4SxLFlWlP+hggILMIIC
...
# DxcNMTYwODIyMTU1NjEwWjAjBgkqhkiG9w0BCQQxFgQUFRB4udKwPRE5TXkbvyOg
# +UPAcz0wDQYJKoZIhvcNAQEBBQAEggEAcVQjWUzitfTnHfI5dwPknfC1KejPZ8ec
# KkeUmuNYsXzqbCW5EK/3QA67gwB9MvPE3TCToaR1NJG3CoE2h5Edx2kAXeAvdZtw
# Se2VJCwYLOJFdMeHaSpCCVgBtoM0M79HfMA5791igfNO0qd1q6mPkYni2nfe85Eb
# G93Nc5cS0/GrMXsYHoIt5Hue4ZsLnoHCObpU2zodDPmyaAcmbfFfHHozA9sTR2Up
# RCFiF88rOO7F1BOJewDurhgj3CDTy1IiObBZlLqGYxsEj3wxNM/5X5pfK4M9eH07
# y4sIXtQ+yxr9UuqGjeA2I3oBuiQnoPu951R5TQSU1bX+W2iOCvjZBA==
